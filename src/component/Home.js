        ...
        <div >
            ...
            <div className="footer">
                <div className="footer-first">
                    ...
                    <h2 >
                        <a id="info-h2" href="#">About</a><br/>
                        <a id="info-h2" href="#">Patients</a><br/>
                        <a id="info-h2" href="#">Contact</a><br/>
                    </h2>
                ...
                <div className="footer-last">
                    <div>
                        ...
                        <div id="hr-3"><hr/></div>
                        <h2 >
                            <a id="info-h2" href="#">Facebook</a><br/>
                            <a id="info-h2" href="#">Instagram</a><br/>
                        </h2>
                    </div>
                    <div>
                        <h3 id="info-h3">ADDRESS + CONTACT</h3>
                        <hr/>
                        <a href="#">hello@zendentalsf.com</a>
